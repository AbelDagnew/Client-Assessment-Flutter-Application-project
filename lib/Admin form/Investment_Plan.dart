...
import 'Irrigation_Practice.dart';
...
class _InvestmentState extends State<Investment> {
 ...
 decsion(){
  ...
  void registerNewUserr(BuildContext context) async{
    ...
    var natural = int.parse(data24) + int.parse(data25) + int.parse(data26) + int.parse(data27) + int.parse(data28);
    ...
    if(int.parse(kdata5.text) <= total_point_value && int.parse(kdata6.text) <= monitory){
      ...
      Map <String,dynamic> data= {
        ...
        "data74":monitory,
        "data75":"Eligible For Solar Pump",
        "data76":kdata5.text,
        "data77":kdata6.text,
        "data78":kdata7.text,
        "latitude":latitude,
      ...
      FirebaseFirestore.instance.collection('EligibleForSolarPump').add(data);
      FirebaseFirestore.instance.collection('AllRecordDataForSolarPump').add(data);
      ...
      Map <String,dynamic> data= {
        ...
        "data73":total_point_value,
        "data74":monitory,
        "data75":"Not Eligible For Solar Pump",
        "data76":kdata5.text,
        "data77":kdata6.text,
        "data78":kdata7.text,
        "latitude":latitude,
      ...
      FirebaseFirestore.instance.collection('NotEligibleForSolarPump').add(data);
      FirebaseFirestore.instance.collection('AllRecordDataForSolarPump').add(data);
    ...
    if(int.parse(kdata5.text) <= total_point_value && int.parse(kdata6.text) <= monitory){
       ...
       el =  "Eligible For Solar Pump";

    }else{
       el = "NoT Eligible For Solar Pump";
    }
