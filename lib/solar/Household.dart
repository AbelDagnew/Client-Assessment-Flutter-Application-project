...
import 'package:untitled4/solar/capital_physical.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Household_profile_Registeration_formsolar(),
    );
  }
}
// ignore: camel_case_types
class Household_profile_Registeration_formsolar extends StatefulWidget {
  final  String uid;
  final String submit;
  Household_profile_Registeration_formsolar({Key key, @required this.submit, this.uid}): super (key: key);

  @override
  _Household_profile_Registeration_formsolarState createState() =>
      _Household_profile_Registeration_formsolarState(uid,submit);
}

// ignore: camel_case_types
class _Household_profile_Registeration_formsolarState
    extends State<Household_profile_Registeration_formsolar> {

  final String uid;
  final String submit;
  _Household_profile_Registeration_formsolarState(this.uid,this.submit);
