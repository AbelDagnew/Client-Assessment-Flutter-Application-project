...
class AdminRecTv extends StatefulWidget {
  @override
  _AdminRecTvState createState() => _AdminRecTvState();
}

class _AdminRecTvState extends State<AdminRecTv> {
  int _currentIndex = 0;
  final tabs =[
...
class _ListpageState extends State<Listpage> {
  ...
  Future getPosts() async{
    ...
    QuerySnapshot qn = await firestore.collection("AllRecordDataForSolarTv").get();
    return qn.docs;
  }
...
class _Listpage2State extends State<Listpage2> {
  ...
  Future getPosts() async{
    var firestore = FirebaseFirestore.instance;
    QuerySnapshot qn = await firestore.collection("EligibleForSolarTv").get();
    return qn.docs;
  }
  navigateToDetail(DocumentSnapshot post){
...
class _Listpage3State extends State<Listpage3> {
  ...
  Future getPosts() async{
    var firestore = FirebaseFirestore.instance;
    QuerySnapshot qn = await firestore.collection("NotEligibleForSolarTv").get();
    return qn.docs;
  }
  navigateToDetail(DocumentSnapshot post){
    Navigator.push(context, MaterialPageRoute(builder: (context) => Dialogpage2(post: post,)));
