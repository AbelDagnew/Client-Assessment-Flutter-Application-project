...
class BeforeRecord extends StatefulWidget {


  @override
  _BeforeRecordState createState() => _BeforeRecordState();
}

class _BeforeRecordState extends State<BeforeRecord> {
  @override
                ...
                Column(
                  children: [
                    ...
                    RaisedButton(
                        ...
                        child: Text('Solar House System', style: TextStyle(
                            color: Colors.white),)
                    ),
