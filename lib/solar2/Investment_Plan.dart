...
import 'package:untitled4/solar2/Irrigation_Practice.dart';
 ...
 decsion(){
  ...
  void registerNewUserr(BuildContext context) async{
    ...
    if(int.parse(kdata5.text) <= total_point_value && int.parse(kdata6.text) <= monitory){
      ...
      FirebaseFirestore.instance.collection('EligibleForSolarLight').add(data);
      FirebaseFirestore.instance.collection('AllRecordDataForSolarLight').add(data);
      ...
      FirebaseFirestore.instance.collection('NotEligibleSolarLight').add(data);
      FirebaseFirestore.instance.collection('AllRecordDataForSolarLight').add(data);
    ...
    if(int.parse(kdata5.text) <= total_point_value && int.parse(kdata6.text) <= monitory){
       ...
       el =  "Eligible For Solar Light";

    }else{
       el = "NoT Eligible For Solar Light";
    }
