...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Household_profile_Registeration_formsolar2(),
    );
  }
}
// ignore: camel_case_types
class Household_profile_Registeration_formsolar2 extends StatefulWidget {
  final  String uid;
  final String submit;
  Household_profile_Registeration_formsolar2({Key key, @required this.submit, this.uid}): super (key: key);

  @override
  _Household_profile_Registeration_formsolar2State createState() =>
      _Household_profile_Registeration_formsolar2State(uid,submit);
}

// ignore: camel_case_types
class _Household_profile_Registeration_formsolar2State
    extends State<Household_profile_Registeration_formsolar2> {

  final String uid;
  final String submit;
  _Household_profile_Registeration_formsolar2State(this.uid,this.submit);
